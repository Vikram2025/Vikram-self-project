...
PlayerdtoObj ply = null;
	...
	public String addPlayer(PlayerdtoObj player) {
		...
		PreSta.setInt(1, player.getId());
		PreSta.setString(2, player.getName());
		PreSta.setString(3, player.getTeamname());
		PreSta.setInt(4, player.getSalary());
		
		int lineinsert =PreSta.executeUpdate();
		System.out.println("this is a imp class obj "+ lineinsert );
	...
	public String updatePlayer(PlayerdtoObj player) {
		...
		PreSta.setInt(4, player.getId());
		PreSta.setString(1, player.getName());
		PreSta.setString(2, player.getTeamname());
		PreSta.setInt(3, player.getSalary());
