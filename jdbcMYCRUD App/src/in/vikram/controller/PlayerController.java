...
public class PlayerController {
	...
	public static void main(String[] args) {
		...
		System.out.println( );
		System.out.println("enter the value 2 for deleting data of a player ");
		System.out.println( );
	...
	int salary = scan.nextInt();
	 ...
	 String P1data =playerservice.addPlayer(id, name, teamname, salary);
           ...
           if(P2details.equalsIgnoreCase("success")) {
            ...
            if(myvalue==4) {
              ...
              System.out.println(plydtoObj.getId() +"\t"+plydtoObj.getName() +"\t   "+   plydtoObj.getTeamname() +"\t        "
            	  ...
            	  System.out.println("the  id number" + id +"  which you have enetred for a player is incorrect ");
              }
